...
const routes = [
  ...
  {
    path: "/mypage",
    component: () => import(/* webpackChunkName: "home" */ "./components/Customised/LinksignFeatureList.vue"),
    // redirect: `${adminRoot}/piaf`,
  },
  {
    path: "/otherpage",
    component: () => import(/* webpackChunkName: "home" */ "./components/Customised/ContractQuickStartCreation.vue"),
    // redirect: `${adminRoot}/piaf`,
  },
  {
    path: adminRoot,
